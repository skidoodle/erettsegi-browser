...
const ResourceComponent = ({ label, link }: ResourceProps) => {
	...
	return (
		<Button
			...
			isPending={isLoading}
			onPress={handleClick}
			className={`w-full h-11 text-sm font-semibold transition-colors data-[disabled=true]:opacity-50 ${
				isOk
					? "bg-[#006FEE] hover:bg-[#005BC4] text-white"
					: isDead
						? "bg-[#F31260]/10 dark:bg-[#F31260]/20 hover:bg-[#F31260]/20 dark:hover:bg-[#F31260]/30 text-[#F31260] line-through"
						: "bg-gray-200 dark:bg-[#27272a] hover:bg-gray-300 dark:hover:bg-[#3f3f46] text-gray-600 dark:text-zinc-400"
			}`}
		>
			{({ isPending }) => (
				<>
